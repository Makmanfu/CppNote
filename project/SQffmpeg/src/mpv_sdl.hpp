...
struct mpv_sdl
{
    ...
    {
        SDL_Event event = { event.type = wakeup_on_mpv_events };
        SDL_PushEvent(&event);
    };

    static void on_mpv_redraw(void* ctx)
    {
        SDL_Event event = { event.type = wakeup_on_mpv_redraw };
        SDL_PushEvent(&event);
    };
    ...
    static int start(int argc, char** argv)
    {
        ...
        mpv_render_param params[] = {
            ...
            { MPV_RENDER_PARAM_OPENGL_INIT_PARAMS, nullptr },
        ...
        while (1)
        {
            ...
            if (redraw)
            {
                ...
                mpv_render_param params[] =
                {
                    ...
                    {
                        MPV_RENDER_PARAM_OPENGL_FBO, nullptr/*&(mpv_opengl_fbo) {mpv_opengl_fbo::fbo = 0,w = w,h = h,}*/
                    },
                    // Flip rendering (needed due to flipped GL coordinate system).
                    {
                        MPV_RENDER_PARAM_FLIP_Y, nullptr/*&(int){1}*/
                    },
                    { MPV_RENDER_PARAM_INVALID, nullptr }
                };
