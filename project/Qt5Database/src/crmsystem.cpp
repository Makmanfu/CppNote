...
void TabModel::setHead(void)
{
    ...
    this->setHeaderData(1, Qt::Horizontal, QString::fromLocal8Bit("用户名称"));
    this->setHeaderData(2, Qt::Horizontal, QString::fromLocal8Bit("用户密码"));
    this->setHeaderData(3, Qt::Horizontal, QString::fromLocal8Bit("用户角色"));
}
...
{
    m_ationAdd = new QAction(QString::fromLocal8Bit("添加"), this);
    m_ationModify = new QAction(QString::fromLocal8Bit("修改"), this);
    m_ationDelete = new QAction(QString::fromLocal8Bit("删除"), this);
    m_ationShow = new QAction(QString::fromLocal8Bit("刷新数据"), this);
...
, m_checkNum(3)
{
    ...
    this->setWindowTitle(QString::fromLocal8Bit("用户登陆"));
    gridLayout = new QGridLayout(this);
    gridLayout->setSpacing(6);
    gridLayout->setContentsMargins(11, 11, 11, 11);
    label = new QLabel(this);
    label->setText(QString::fromLocal8Bit("用户名:"));
    gridLayout->addWidget(label, 0, 0, 1, 1);
    EditUserName = new QLineEdit(this);
    EditUserName->setText(QString::fromLocal8Bit("admin"));
    ...
    EditUserPass->setText(QString::fromLocal8Bit("123"));
    EditUserPass->setEchoMode(QLineEdit::Password);
    gridLayout->addWidget(EditUserPass, 1, 1, 1, 2);
    label_3 = new QLabel(this);
    label_3->setText(QString::fromLocal8Bit("角色:"));
    gridLayout->addWidget(label_3, 2, 0, 1, 1);
    comboBoxRole = new QComboBox(this);
    comboBoxRole->clear();
    comboBoxRole->insertItem(0, QString::fromLocal8Bit("普通用户"));
    comboBoxRole->insertItem(1, QString::fromLocal8Bit("系统管理员"));
    gridLayout->addWidget(comboBoxRole, 2, 1, 1, 2);
    BtnOK = new QPushButton(this);
    BtnOK->setText(QString::fromLocal8Bit("登陆"));
    gridLayout->addWidget(BtnOK, 3, 1, 1, 1);
    BtnCancle = new QPushButton(this);
    BtnCancle->setText(QString::fromLocal8Bit("取消"));
...
{
    this->setWindowTitle(QString::fromLocal8Bit("用户编辑"));
    //编辑时显示
...
void dlgUserEdit::On_OKClicked()
{
    ...
    if (usrdata.username.isEmpty() || usrdata.password.isEmpty())
        QMessageBox::information(this, QString::fromLocal8Bit("提示"), QString::fromLocal8Bit("用户名或密码不能为空!"));
    else
        accept();
}
...
void dlgFrame::InitGui(void)
{
    ...
    setBox->setTitle(QString::fromLocal8Bit("控制面板"));
    stateBox = new QGroupBox(m_wPanel);
    stateBox->setTitle(QString::fromLocal8Bit("状态信息"));
    ...
    m_labtabname->setText(QString::fromLocal8Bit("当前表名:"));
    m_comBoxName = new QComboBox(setBox);
    m_labusername = new QLabel(setBox);
    m_labusername->setText(QString::fromLocal8Bit("当前用户:"));
    ...
    m_btnSql->setText(QString::fromLocal8Bit("执行SQL"));
