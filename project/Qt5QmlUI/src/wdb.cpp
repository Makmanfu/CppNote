...
TableView::TableView(QWidget* parent) : QTableView(parent)
{
    ...
    Act_edt = new QAction(TCSR("编辑"), this);
    Act_del = new QAction(TCSR("删除"), this);
    Act_addroot = new QAction(TCSR("添加(root)"), this);
...
TreeView::TreeView(QWidget* _parent) : QTreeView(_parent)
{
    ...
    testdat.insert(TCSR("航母系列"), objtest);
    testdat.insert(TCSR("雷达系列"), objtest);
    testdat.insert(TCSR("飞机系列"), objtest);
    testdat.insert(TCSR("其他"), objtest);
    //加载数据
...
void TreeView::setMenuInit(void)
{
    ...
    menutb->addSeparator();
    Act_addroot = new QAction(TCSR("添加根节点"), this);
