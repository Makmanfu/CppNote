...
int mainImage(void)
{
    ...
    IpVec ipts;
    IplImage* img = cvLoadImage("../Resource/OpenSURF/sf.jpg");
...
int mainMatch(void)
{
    ...
    // Replace the line below with IplImage *img = cvLoadImage("../Resource/OpenSURF/object.jpg");
    // where object.jpg is the planar object to be located in the video
    IplImage* img = cvLoadImage("../Resource/OpenSURF/object.jpg");
...
{
    IplImage* img1, *img2;
    img1 = cvLoadImage("../Resource/OpenSURF/img1.jpg");
    img2 = cvLoadImage("../Resource/OpenSURF/img2.jpg");
    IpVec ipts1, ipts2;
...
int mainKmeans(void)
{
    IplImage* img = cvLoadImage("../Resource/OpenSURF/img1.jpg");
    IpVec ipts;
    Kmeans km;
    // Get Ipoints
