...
public:
    ...
    virtual void SetCastMode(EnCastMode enCastMode)
    {
        m_enCastMode           = enCastMode;
    }
    virtual void SetMultiCastTtl(int iMCTtl)
    {
        m_iMCTtl               = iMCTtl;
    }
    virtual void SetMultiCastLoop(BOOL bMCLoop)
    {
        m_bMCLoop              = bMCLoop;
    }
    ...
    virtual EnCastMode GetCastMode()
    {
        return m_enCastMode;
    }
