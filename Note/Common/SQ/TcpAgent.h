...
public:
    ...
    {
        return DoSendPackets(dwConnID, pBuffers, iCount);
    }
...
public:
    ...
    virtual void SetReuseAddress(BOOL bReuseAddress)
    {
        m_bReuseAddress            = bReuseAddress;
    }
    ...
    virtual BOOL  IsReuseAddress()
    {
        return m_bReuseAddress;
    }
