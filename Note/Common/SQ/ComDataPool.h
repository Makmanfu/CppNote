...
private:
    inline bool isUsed(size_type* poffset)
    {
        return (*poffset & 0x80000000);
    }
    inline bool isUnused(size_type* poffset)
    {
        return (!isUsed(poffset));
    }
    inline void setUsed(size_type* poffset)
    {
        *poffset |= 0x80000000;
    }
    inline void setUnused(size_type* poffset)
    {
        *poffset &= 0x7fffffff;
    }
    inline size_type getIndex(size_type offset)
    {
